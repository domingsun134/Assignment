#!/usr/bin/env python3
"""
Script to pull the Phi-3 model in the Ollama container
"""
...
def check_model_exists():
    """Check if Phi-3 model already exists"""
    try:
...
def main():
    """Main function"""
    print("🤖 Phi-3 Model Setup Script")
    print("=" * 40)
    ...
    # Pull the model
    if pull_model():
        print("🎉 Setup complete! The chatbot is ready to use.")
    else:
